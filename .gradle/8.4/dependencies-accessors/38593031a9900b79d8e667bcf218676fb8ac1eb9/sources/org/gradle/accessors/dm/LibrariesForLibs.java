...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class HiltLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        public HiltLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
            ...
            /**
             * Creates a dependency provider for kapt (com.google.dagger:hilt-compiler)
             * This dependency was declared in catalog libs.versions.toml
             */
    ...
    public static class RetrofitVersionAccessors extends VersionFactory  implements VersionNotationSupplier {
        ...
        /**
         * Returns the group of versions at versions.retrofit.converter
         */
    ...
    public static class RetrofitConverterVersionAccessors extends VersionFactory  {
        ...
        public RetrofitConverterVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: retrofit.converter.gson (2.9.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
    ...
    public static class PluginAccessors extends PluginFactory {
        ...
        public PluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Creates a plugin provider for kapt to the plugin id 'kotlin-kapt'
             * This plugin was declared in catalog libs.versions.toml
             */
